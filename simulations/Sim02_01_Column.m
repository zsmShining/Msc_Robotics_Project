...
fleet_track = [];
%% setup the follower
fo1 = agent(2,"follower",[4,0,pi/2],[0,0]);
fo2 = agent(3,"follower",[-4,0,pi/2],[0,0]);
f1ErrorTrack = [];
f2ErrorTrack = [];
follower_track = [];
fo1StateTrack = [];
...
subplot(2,1,1)
hold on
plot(((1:length(f1ErrorTrack(:,1)))*dt),f1ErrorTrack(:,1));
plot(((1:length(f1ErrorTrack(:,2)))*dt),f1ErrorTrack(:,2));
plot(((1:length(f1ErrorTrack(:,3)))*dt),f1ErrorTrack(:,3));
legend("Xei","Yei","Thetaei")
% relDisError1 = [];
...
subplot(2,1,2)
hold on
plot(((1:length(f2ErrorTrack(:,1)))*dt),f2ErrorTrack(:,1));
plot(((1:length(f2ErrorTrack(:,2)))*dt),f2ErrorTrack(:,2));
plot(((1:length(f2ErrorTrack(:,3)))*dt),f2ErrorTrack(:,3));
legend("Xei","Yei","Thetaei");
% relDisError1 = [];
% for i = 1:length(f1ErrorTrack(:,1))
