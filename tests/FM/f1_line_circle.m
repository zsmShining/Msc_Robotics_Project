...
fleet_track = [];
%% setup the follower
fo1 = agent(2,"follower",[0,-4,pi/2],[0,0]);
fo2 = agent(3,"follower",[0,-8,pi/2],[0,0]);
f1ErrorTrack = [];
f2ErrorTrack = [];
follower_track = [];
fo1StateTrack = [];
...
KMatrix = [4,1,0.1;2,1.5,0.1;1,0.5,0.1];Boundary = [0,10;-10,10;-10,10];
Lamda1 = [2,1.5];
ctrF1 = formation_controller(KMatrix,Boundary,Lamda1,dt);

%% setup Formation Controller2
%KMatrix2 = [4,1,0.01;2,0.5,0.01;2,0.5,0.01];
KMatrix2 = [4,1,0.1;2,1.5,0.1;1.5,0.5,0.1];Boundary = [0,10;-10,10;-10,10];
Lamda2 = [2,1.5];
