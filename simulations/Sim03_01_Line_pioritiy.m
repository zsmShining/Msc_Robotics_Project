...
KMatrix = [1,0.1,0.01;2,0.5,0.01;1,1,0.01];
Boundary1 = [-1,4;-10,10;-10,10];
Lamda1 = [1,1];
...
KMatrix2 = [1,0.4,0.01;2.0,0.5,0.1;2.0,1,0.2];

Boundary2 = [-1,4;-10,10;-10,10];
Lamda2 = [1,1];
