...
KMatrix = [4,0.1,0.1;2,0.5,0.01;2,1,0.1];
Boundary1 = [0,5;-2,2;-1,1];
Lamda1 = [1,2];
...
for t = 0:simStep
    ...
    theta = atan2(ACvector(2),ACvector(1));
...
%     leader = leader.set("linearSpeed",AC_vel_c);
    ...
    leader = leader.set("linearSpeed",AC_vel_c);
%     leader = leader.set("orientation",theta);
...
%     f2ACvector = fo2.calAvoidCollision({obs1,obs2,obs3},FK2vector);
